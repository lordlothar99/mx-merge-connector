...
public class LocationsList extends CustomJavaAction<IMendixObject>
{
	...
	private merge.proxies.LocationsListParams params;

	public LocationsList(IContext context, java.lang.String apiKey, IMendixObject params)
	{
		super(context);
		this.apiKey = apiKey;
	...
	{
		this.params = __params == null ? null : merge.proxies.LocationsListParams.initialize(getContext(), __params);
	...
	private static PaginatedLocationList getLocations(String apiKey, LocationsListParams params) throws ApiException {
